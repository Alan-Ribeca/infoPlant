            ...
            index === 0 && (
              <div className="contenedor" key={index}>
                <article data-aos="fade-right" className="containerImgs">
                  {cuidado.imagenes.map((img, index) => (
                    <img
                      src={img.src}
                      alt="imagen de la planta {cuidado.nombre}"
                      className="imgInfo"
                      key={index}
                    />
                  ))}
                ...
                <article data-aos="fade-left" className="infoTexto">
                  <h2 className="titleCuidado">
                    Cuidados basicos para tu {cuidado.nombre}
                  </h2>
                  <ul className="datos">
                    <li className="liCuidados">
                      ...
                      <span className="cuidadosP">{cuidado.nivelCuidado}</span>
                    </li>
                    <li className="liCuidados">
                      <svg
                        id="Layer_1"
                      ...
                      <span className="cuidadosP">{cuidado.aire}</span>
                    </li>
                    <li className="liCuidados">
                      <svg
                      ...
                      <span className="cuidadosP">{cuidado.riego}</span>
                    </li>
                  </ul>
                  ...
                  <ul className="cuidadoGuia">
                    <li className="gia">
                      ...
                      <span className="guiaTexto">Luz: {cuidado.luz}</span>
                    </li>
                    <li className="gia">
                      <img
                        src="../img/riego.png"
                    ...
                    <li className="gia">
                      ...
                      <span className="guiaTexto">Tips: {cuidado.tips}</span>
                    </li>
                    <li className="gia">
                      <img
                      ...
                      />
                      <span className="guiaTexto">
                        Crecimiento: {cuidado.crecimiento}
                      </span>
                    </li>
                    <li className="gia">
                      <img
